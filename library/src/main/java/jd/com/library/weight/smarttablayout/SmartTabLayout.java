 ...
 */
package jd.com.library.weight.smarttablayout;
...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (selectedIndicatorListener != null) {
                selectedIndicatorListener.onSelectedIndicator(position);
            }
        }
    ...
    private SelectedIndicatorListener selectedIndicatorListener;

    /**
     * 监听当前选择项
     *
     * @param selectedIndicatorListener
     */
    public void setonSelectedIndicatorListener(SelectedIndicatorListener selectedIndicatorListener) {
        this.selectedIndicatorListener = selectedIndicatorListener;
    }

    public interface SelectedIndicatorListener {
        void onSelectedIndicator(int position);
    }

    public void setonCurrentIndicator(int position) {
